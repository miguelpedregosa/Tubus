...
jQuery.fn.iphoneSwitch = function(start_state, switched_on_callback, switched_off_callback, options) {
	...
	var settings = {
		mouse_over: 'pointer',
		mouse_out:  'default',
		switch_on_container_path: 'js/iphone_switch_container_on.png',
		switch_off_container_path: 'js/iphone_switch_container_off.png',
		switch_path: 'js/iphone_switch.png',
		switch_height: 27,
		switch_width: 94
	};
		...
		jQuery(this).click(function() {
			if(state == 'on') {
				jQuery(this).find('.iphone_switch').animate({backgroundPosition: -53}, "slow", function() {
					jQuery(this).attr('src', 'js/iphone_switch_container_off.png');
				...
				jQuery(this).find('.iphone_switch').attr('src', 'js/iphone_switch_container_on.png');
				state = 'on';
			}
		});		
