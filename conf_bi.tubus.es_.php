...
$configuracion['ciudad'] = 'Bilbao'; // Home url, without tralling slash
...
$configuracion['cache_prefix'] = 'bi.tubus'; 
...
$configuracion['bd_basedatos'] = 'tubus_bi'; //

$configuracion['conector'] = 'bilbobus.php'; //

//Datos para mostrar el mapa de la ciudad
$configuracion['mapa_lat'] = 43.25733; 
$configuracion['mapa_long'] = -2.92339; //
