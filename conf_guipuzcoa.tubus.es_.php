...
$configuracion['ciudad'] = 'Guipúzcoa'; // Home url, without tralling slash
...
$configuracion['cache_prefix'] = 'guipuzcoa.tubus'; 
...
$configuracion['bd_basedatos'] = 'tubus_guipuzcoa'; //

$configuracion['conector'] = 'lurraldebus.php'; //
