...
require_once '/home/tubus/httpdocs/m.tubus.es/conf_gr.tubus.es_.php';
...
function initialize() {
    ...
    var latlng = new google.maps.LatLng(37.173098, -3.600442);
    var myOptions = {
      zoom: 15,
      center: latlng,
...
<form id="form1" name="form1" method="post" action="geogmaps.php">
...
<div>
<form id="gdatos" name="gdatos" method="post" action="geogmaps.php">
<table width="100%" border="0">
  <tr>
    <th width="21%" scope="row"><div align="justify">Parada</div></th>
    <td width="79%"><div align="justify">
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td><div align="justify"><a target="_blank" href="http://tubus.es/<?=$datos['nombre']?>">http://tubus.es/<?=$datos['nombre']?></a></div></td>
  </tr>
  <tr>
    <th scope="row"><div align="justify"></div></th>
    <td><div align="justify"><a href="geogmaps.php">[[Localizar otra parada]] </a></div></td>
  </tr>
</table>
</body>
</html>
...
<body>
<h1>Geolocalización de paradas usando Google Maps</h1>
<p>Ha ocurrido un error al localizar la parada. <a href="geogmaps.php">[[Volver a intentar]] </a></p>
</body>
</html>
<?php                   
        }    
