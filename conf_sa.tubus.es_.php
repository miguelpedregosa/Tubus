...
$configuracion['ciudad'] = 'Santander'; // Home url, without tralling slash
...
$configuracion['cache_prefix'] = 'sa.tubus'; 
...
$configuracion['bd_basedatos'] = 'tubus_sa'; //

$configuracion['conector'] = 'tus.php'; //

//Datos para mostrar el mapa de la ciudad
$configuracion['mapa_lat'] = 43.4619; 
$configuracion['mapa_long'] = -3.8107; //43.4619, -3.8107
