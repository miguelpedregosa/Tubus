...
$configuracion['ciudad'] = 'Córdoba'; // Home url, without tralling slash
...
$configuracion['cache_prefix'] = 'co.tubus'; 
...
$configuracion['bd_basedatos'] = 'tubus_co'; //

$configuracion['conector'] = 'aucorsa.php'; //
